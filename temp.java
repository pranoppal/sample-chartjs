...
public class SecureRestTemplateJKS {
    ...
    public static RestTemplate createRestTemplate(String keystorePath, String keystorePassword) throws Exception {
        ...
        // Configure connection manager using PoolingAsyncClientConnectionManager
        Registry<ConnectionSocketFactory> socketFactoryRegistry = RegistryBuilder.<ConnectionSocketFactory>create()
                .register("https", sslSocketFactory)
                .register("http", new PlainConnectionSocketFactory())
                .build();

        PoolingAsyncClientConnectionManager connectionManager = new PoolingAsyncClientConnectionManager(socketFactoryRegistry);
